...
export default function RouteDesign9() {
    ...
    <div className={`${fredoka.variable} ${nunito.variable}`} style={{ minHeight: "100vh", background: "#D6EAF8", display: "flex", justifyContent: "center" }}>
      <div style={{ width: "100%", maxWidth: 390, background: C.bg, minHeight: "100vh", paddingBottom: 88 }}>
        ...
        <div style={{ background: `linear-gradient(135deg, ${C.coral}, ${C.teal})`, padding: "14px 16px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <span style={{ ...fb, fontSize: 11, color: "rgba(255,255,255,0.8)", fontWeight: 600 }}>Design 9 · Social</span>
        </div>
        ...
        <div style={{ padding: "16px 14px 0" }}>
          ...
          <div style={{ background: C.surface, borderRadius: 20, padding: 16, marginBottom: 12, boxShadow: "0 2px 12px rgba(0,0,0,0.06)" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
              ...
              {!isEditing && (
                <button onClick={handleEditStart} aria-label="Edit note" style={{ ...fb, fontSize: 12, fontWeight: 700, color: "white", background: C.teal, border: "none", borderRadius: 20, padding: "6px 16px", cursor: "pointer" }}>Edit</button>
              )}
            </div>
            {isEditing ? (
              <div>
                ...
                <div style={{ display: "flex", gap: 8, marginTop: 10 }}>
                  <button onClick={handleSave} aria-label="Save note" style={{ ...fb, flex: 1, padding: "12px 0", borderRadius: 14, border: "none", background: C.teal, color: "white", fontSize: 14, fontWeight: 800, cursor: "pointer" }}>
                    ✓ Save
                  </button>
                  <button onClick={handleCancel} aria-label="Cancel" style={{ ...fb, flex: 1, padding: "12px 0", borderRadius: 14, border: `2px solid ${C.border}`, background: "white", color: C.muted, fontSize: 14, fontWeight: 700, cursor: "pointer" }}>
                    ✕ Cancel
                  </button>
                </div>
              </div>
